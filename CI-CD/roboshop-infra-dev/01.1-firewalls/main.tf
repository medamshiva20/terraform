module "vpn_sg" {
  ...
  sg_description = "Allowing traffic to my home IP address"
...
#This is allowing traffic from VPN on port no 22 for trouble shooting purpose
...
resource "aws_security_group_rule" "redis_user" {
  type            = "ingress"
  description = "Allowing port number 6379 from Web"
  from_port       = 6379
  to_port         = 6379
  protocol        = "tcp"
  source_security_group_id = module.web_sg.security_group_id
...
resource "aws_security_group_rule" "user_app_alb" {
  type            = "ingress"
  description = "Allowing port number 8080 from Web"
  from_port       = 8080
  to_port         = 8080
  protocol        = "tcp"
  source_security_group_id = module.app_alb_sg.security_group_id
